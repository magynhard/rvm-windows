...
RvmCliHelp.SECTIONS.help = [
    ...
    },
    {
        content: [
            ...
            {name: 'proxy', alias: 'p', summary: 'Get the configured proxy host.'},
            {name: 'proxy <host>', alias: 'p <host>', summary: 'Set the proxy server host. E.g. http://proxy:12345'},
            {name: 'proxy delete', alias: 'pd', summary: 'Remove the proxy server host.'},
            {name: 'reinstall <version>', alias: 'r', summary: 'Delete given ruby environment and install it again.'},
            {name: 'remove', alias: 'rem', summary: 'Delete given ruby environment (alias: uninstall)'},
